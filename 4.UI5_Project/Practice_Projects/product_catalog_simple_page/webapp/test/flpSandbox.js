		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#productcatalogsimplepage-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"productcatalogsimplepage-display": {
								"semanticObject": "productcatalogsimplepage",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=productcatalogsimplepage",
									"url": sap.ui.require.toUrl("productcatalogsimplepage")
								}
							}
						}
					}
