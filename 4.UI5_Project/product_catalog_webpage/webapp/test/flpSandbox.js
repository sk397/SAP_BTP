		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Product Catalog Webpage",
									"targetURL": "#productcatalogwebpage-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"productcatalogwebpage-display": {
								"semanticObject": "productcatalogwebpage",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=productcatalogwebpage",
									"url": sap.ui.require.toUrl("productcatalogwebpage")
								}
							}
						}
					}
